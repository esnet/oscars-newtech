...
public class ConnectionServiceRequester extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/haniotak/ij/oscars-newtech/nsi/src/main/resources/schema/ogf_nsi_connection_requester_v2_0.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ConnectionServiceRequester.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/haniotak/ij/oscars-newtech/nsi/src/main/resources/schema/ogf_nsi_connection_requester_v2_0.wsdl");
        }
        WSDL_LOCATION = url;
    }
